...
class TaskAdapter(var TaskList : MutableList<Task>) : RecyclerView.Adapter<TaskViewHolder>() {
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.task_single_item,parent,false)
